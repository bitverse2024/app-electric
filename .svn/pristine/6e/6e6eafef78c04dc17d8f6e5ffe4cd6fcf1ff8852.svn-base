<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="createpayregadjcom.aspx.cs" Inherits="HRIS_APPELECTRIC.Pages.Admin.PayrollPages.createpayregadjcom" %>
                            ...
                            <div class="container-fluid">
                                ...
                                <section class="card">
                                    <div class="card-header">
                                        ...
                                        <a href="payregadjcom.aspx" class="btn btn-default"><i class="fa fa-list"></i><span class="h6">List</span></a>
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="row">
                                                                <div class="form col-lg-4">
                                                                    ...
                                                                    <label for="lblEmp" class="required">Employee Name <span class="required text-red">**</span>
                                                                ...
                                                                <div class="form col-lg-4">
                                                                    <label for="lblComp" class="required">Compensation</label><br />
                                                                    <asp:DropDownList ID="ddlComp" CssClass="form-control" runat="server" Width="300px"></asp:DropDownList>
