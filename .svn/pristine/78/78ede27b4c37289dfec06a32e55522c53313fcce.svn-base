<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="finalpay.aspx.cs" Inherits="HRIS_APPELECTRIC.Pages.Admin.PayrollPages.finalpay" %>
                    ...
                    <div class="col-md-12">
                        <div class="content">
                            <div class="container-fluid">
                                ...
                                <h3 class="m-0 text-dark">Payroll<small> Process Final Pay</small></h3>
                                <section class="card">
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form col-lg-6">
                                                                    <label for="lblEmp" class="required">Employee Name</label><br />
