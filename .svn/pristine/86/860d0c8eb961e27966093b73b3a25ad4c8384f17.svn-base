                    ...
                    <div class="modal-body">
                     ...
                     <div class="row">
	                    <!-- Modal Content -->
  	                    ...
  	                    <div class="col-lg-6">
                                <label for="rst_Password" class="required">Password <span class="required text-red">**</span></label><asp:RequiredFieldValidator ID="RequiredFieldValidator7" ControlToValidate="rst_Password" ForeColor="Red" runat="server" ErrorMessage="Field Required" ValidationGroup="ResetPasswordGroup"></asp:RequiredFieldValidator>	
