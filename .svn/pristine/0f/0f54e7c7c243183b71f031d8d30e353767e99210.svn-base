            ...
            <hr>--%>
                                        ...
                                        <div class="search-form" style="display: none">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <label for="Empgroup_GroupName" class="required">Location Name <span class="required text-red">**</span></label><input class="form-control" maxlength="30" name="Empgroup[GroupName]" id="Empgroup_GroupName" type="text">
                                                </div>
                                            </div>
