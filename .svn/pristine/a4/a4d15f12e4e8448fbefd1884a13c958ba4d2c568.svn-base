...
public class Employee
{
    ...
    public DataTable populateGridEmployeeMaster()
    {
        ...
        cmd = new SqlCommand("Select * from TBL_EMPLOYEE_MASTER A ,TBL_DEPARTMENT B, TBL_POSITION C, TBL_RANK D, TBL_STATUS E where emp_Active !='A' AND A.emp_Department = B.id  AND A.emp_Position = C.id AND A.emp_Rank = D.id AND A.emp_Status = E.id Order by emp_FullName asc", conn);
        dread = cmd.ExecuteReader();
        while (dread.Read())
        {
            string active = "";
    ...
    public DataTable populateGridEmployeeMaster_Sorted(string sort_argument, string attrib)
    {
        ...
        conn.Open();
        //cmd = new SqlCommand("Select * from TBL_USERS where user_Status='ACTIVE'", conn);
        cmd = new SqlCommand("Select * from TBL_EMPLOYEE_MASTER where emp_Active!='A' Order by emp_FullName asc", conn);
        dread = cmd.ExecuteReader();
        while (dread.Read())
        {
            string active = "";
    ...
    public DataTable populateGridEmployee3Mos()
    {
        ...
        while (dread.Read())
        {
            if(dread["emp_EmpID"].ToString() != "" && dread["DateDiff"].ToString() != "")
            {
    ...
    public DataTable populateGridEmployeelistCol(string expr)
    {
        ...
        qry += (expr == "" ? "" : expr);
        string ordr = " Order by emp_FullName asc";
        qry += ordr;
        dt = new DataTable();
        dt.Columns.AddRange(new DataColumn[7] { new DataColumn("EmployeeNo"), new DataColumn("FullName"),
            new DataColumn("Position"), new DataColumn("Department"), new DataColumn("Rank"), new DataColumn("Status"), new DataColumn("Active") });
    ...
    public DataTable populateGridOBTMasterOld()
    {
        dt = new DataTable();
    ...
    public DataTable populateGridOBTMasterColOld(string fname)
    {
        //string base_query = "Select * from TBL_LICENSE where EmpID = '" + empno + "' and (license_type = '" + lictype + "' or license_no = '" + licno + "' or lic_expirydate = '" + licdate + "')";
    ...
    public DataTable populateGridEmployeeMasterEFiling()
    {
        dt = new DataTable();
        dt.Columns.AddRange(new DataColumn[2] { new DataColumn("empid"), new DataColumn("FullName") });
        conn = new SqlConnection(connectionstring);
    ...
    public DataTable populateGridEmployeeMasterEFilingCol(string expr)
    {
        //string base_query = "Select * from TBL_LICENSE where EmpID = '" + empno + "' and (license_type = '" + lictype + "' or license_no = '" + licno + "' or lic_expirydate = '" + licdate + "')";
        //string base_query = "Select * from TBL_EMPLOYEE_MASTER where emp_Active!='A' and emp_FullName like '%" + fname + "%' order by emp_FullName asc";
        string base_query = "Select * from TBL_EMPLOYEE_MASTER where emp_Active!='A' " + expr + " order by emp_FullName asc";
    ...
    public DataTable populateGridDTSMaster()
    {
        ...
        conn = new SqlConnection(connectionstring);
        conn.Open();
        cmd = new SqlCommand("Select * from TBL_EMPLOYEE_MASTER A, TBL_COMPANY B where emp_Active!='A' AND A.emp_Assignment = B.id ORDER by emp_FullName Asc", conn);
        dread = cmd.ExecuteReader();
        while (dread.Read())
        {
            dt.Rows.Add(dread["emp_EmpID"].ToString(), dread["emp_FullName"].ToString(), dread["CoName"].ToString());
    ...
    {
        //string base_query = "Select * from TBL_LICENSE where EmpID = '" + empno + "' and (license_type = '" + lictype + "' or license_no = '" + licno + "' or lic_expirydate = '" + licdate + "')";
        string qry = "Select * from TBL_EMPLOYEE_MASTER A, TBL_COMPANY B where emp_Active!='A' AND A.emp_Assignment = B.id ";
        qry += (expr == "" ? "" : expr);
        qry += " ORDER by A.emp_FullName Asc";
        dt = new DataTable();
        dt.Columns.AddRange(new DataColumn[3] { new DataColumn("empid"), new DataColumn("FullName"), new DataColumn("Company") });
        conn = new SqlConnection(connectionstring);
        conn.Open();
    ...
    public DataTable populateGridEmployeeAdjustment(string empno)
    {
        string Cutoff = "";
        dt = new DataTable();
        dt.Columns.AddRange(new DataColumn[7] { new DataColumn("id"), new DataColumn("EmpID"), new DataColumn("CutOffID"), new DataColumn("SSSDed"), new DataColumn("PhilDed"), new DataColumn("PagibigDed"), new DataColumn("empTax") });
        conn = new SqlConnection(connectionstring);
        conn.Open();
        ...
        while (dread.Read())
        {
            ...
            if(Cutoff != "")
            {
                dt.Rows.Add(dread["id"].ToString(), dread["EmpID"].ToString(), Cutoff, dread["SSSDed"] == DBNull.Value ? "No Adjustment" : toRoundOff(dread["SSSDed"].ToString()), dread["PhilDed"] == DBNull.Value ? "No Adjustment" : toRoundOff(dread["PhilDed"].ToString()), dread["PagibigDed"] == DBNull.Value ? "No Adjustment" : toRoundOff(dread["PagibigDed"].ToString()), dread["empTax"] == DBNull.Value ? "No Adjustment" : toRoundOff(dread["empTax"].ToString()));
            }
    ...
    public ListItem[] GetDropDownMenuList(string tbl, string col, string specificID)
    {
        ...
        while (dread.Read())
        {
            ...
            if (!ddlist.ContainsKey(dread[col].ToString()))
            {
    ...
    public ListItem[] GetDropDownMenuListOrdrBy(string tbl, string col, string specificID, string orderby)
    {
        string stroder = " ";
        stroder += orderby != "" ? orderby : "";
        Dictionary<string, string> ddlist = new Dictionary<string, string>();
        conn = new SqlConnection(connectionstring);
        conn.Open();

        cmd = new SqlCommand("Select * from " + tbl + stroder, conn);
        dread = cmd.ExecuteReader();
            ...
            if (dread["DateDiff"].ToString() != "")
            {
                ...
                if (Convert.ToInt32(dread["DateDiff"].ToString()) >= 150 && Convert.ToInt32(dread["DateDiff"].ToString()) <= 180)
                {
                    if (Convert.ToDateTime(dread["emp_DateStart"].ToString()) > DateTime.Now)
                    {
                        int years = 0;
                        dt.Rows.Add(dread["emp_Surname"].ToString(), dread["emp_Suffix"].ToString(), dread["emp_FirstName"].ToString(),
                            dread["emp_MidName"].ToString(), Convert.ToDateTime(dread["emp_DateStart"]).ToString("MM/dd/yyyy"), dread["StatusDesc"].ToString());
                    }
                    else
                    {
                        time = DateTime.Now - Convert.ToDateTime(dread["emp_DateStart"].ToString());
    ...
    public DataTable populateGridForEmpSchedulerCol(string company, string expr)
    {
        ...
        string qry = "Select * from TBL_EMPLOYEE_MASTER A, TBL_COMPANY B where emp_Active ='Y' AND A.emp_Assignment = B.id";
        if (company != "")
        {
    ...
    public ListItem[] GetDropDownMenuListEmployeeWhereCutOff(string payrollGroup)
    {
        Dictionary<string, string> ddlist = new Dictionary<string, string>();
        conn = new SqlConnection(connectionstring);
        conn.Open();

        cmd = new SqlCommand("Select * from TBL_EMPLOYEE_MASTER where emp_Active = 'Y' and emp_PayrollGroup = " + payrollGroup + " order by emp_FullName asc", conn);
        dread = cmd.ExecuteReader();


        while (dread.Read())
        {
            if (!ddlist.ContainsKey("" + dread["emp_FullName"].ToString() + ""))
            {
                ddlist.Add("" + dread["emp_FullName"].ToString() + "", dread["emp_EmpID"].ToString());
            }
    ...
    public ListItem[] GetDropDownMenuListCutOffWhereEmployeePayrollGroup(string EmpPayrollGroup)
    {
        Dictionary<string, string> ddlist = new Dictionary<string, string>();
        conn = new SqlConnection(connectionstring);
        conn.Open();

        cmd = new SqlCommand("Select * from TBL_CUTOFF where PayrollGroup = " + EmpPayrollGroup + " ORDER by Company asc, MONTH(cofrom) asc", conn);
        dread = cmd.ExecuteReader();


        while (dread.Read())
        {
            if (!ddlist.ContainsKey("" + dread["CDesc"].ToString() + ""))
            {
                ddlist.Add("" + dread["CDesc"].ToString() + "", dread["id"].ToString());
            }
    ...
    public DataTable populateGridEmployeeAdjustmentOthers(string empno)
    {
        string Cutoff = "";
        dt = new DataTable();
        dt.Columns.AddRange(new DataColumn[7] { new DataColumn("id"), new DataColumn("EmpID"),
            new DataColumn("CutOffID"), new DataColumn("AdjustmentAdd"), new DataColumn("AdjustmentOthersAdd"),
            new DataColumn("AdjRemarks"), new DataColumn("AdjOthrsRemarks") });
        conn = new SqlConnection(connectionstring);
        conn.Open();
        cmd = new SqlCommand("Select * from TBL_ADJUSTMENT where EmpID = '" + empno + "'", conn);
        dread = cmd.ExecuteReader();
        while (dread.Read())
        {
            Cutoff = cm.GetSpecificDataFromDB("CDesc", "TBL_CUTOFF", "where id = " + dread["CutOffID"].ToString() + "");
            dt.Rows.Add(dread["id"].ToString(), dread["EmpID"].ToString(), Cutoff,
                dread["AdjustmentAdd"] == DBNull.Value ? "" : toRoundOff(dread["AdjustmentAdd"].ToString()),
                dread["AdjustmentOthersAdd"] == DBNull.Value ? "" : toRoundOff(dread["AdjustmentOthersAdd"].ToString()),
                dread["AdjRemarks"], dread["AdjOthrsRemarks"]);
        }
        dread.Close();
    ...
    public DataTable populateGridEmployeeAdjustmentOthersCol(string expr, string empno)
    {
        string Cutoff = "";
        //string base_query = "Select * from TBL_LICENSE where EmpID = '" + empno + "' and (license_type = '" + lictype + "' or license_no = '" + licno + "' or lic_expirydate = '" + licdate + "')";
        string qry = "Select * from TBL_ADJUSTMENT where EmpID = '" + empno + "' ";
        qry += (expr == "" ? "" : expr);
        dt = new DataTable();
        dt.Columns.AddRange(new DataColumn[7] { new DataColumn("id"), new DataColumn("EmpID"),
            new DataColumn("CutOffID"), new DataColumn("AdjustmentAdd"), new DataColumn("AdjustmentOthersAdd"),
    ...
    public ListItem[] GetDropDownMenuList(string tbl, string col, string specificID, string orderby)
    {
        string stroder = " ";
        stroder += orderby != "" ? orderby : "";
        Dictionary<string, string> ddlist = new Dictionary<string, string>();
    ...
    public DataTable populateGridPaymentHistory(string empno)
    {
        dt = new DataTable();
        dt.Columns.AddRange(new DataColumn[6] { new DataColumn("id"), new DataColumn("Name"), new DataColumn("amountPaid"),
            new DataColumn("beforepaymentbal"), new DataColumn("afterpaymentbal"), new DataColumn("DateTrans")});
        conn = new SqlConnection(connectionstring);
        conn.Open();
        cmd = new SqlCommand("Select B.id,A.Name,B.amountPaid,B.beforepaymentbal,B.afterpaymentbal,B.DateTrans from TBL_LOANENTRIES A, TBL_LOANPAYMENTHISTORY B where A.id = B.LoanEntryID AND A.EmpID = '" + empno + "' order by DateTrans Desc", conn);
        dread = cmd.ExecuteReader();
        while (dread.Read())
        {
            dt.Rows.Add(dread["id"].ToString(), dread["Name"].ToString(), cm.toRoundOff(dread["amountPaid"].ToString()), cm.toRoundOff(dread["beforepaymentbal"].ToString()), cm.toRoundOff(dread["afterpaymentbal"].ToString()), cm.FormatDate(dread["DateTrans"].ToString()));
        }
        dread.Close();
    ...
    public DataTable populateGridPaymentHistoryCol(string empno,string expr)
    {
        string qry = "Select B.id,A.Name,B.amountPaid,B.beforepaymentbal,B.afterpaymentbal," +
            "B.DateTrans from TBL_LOANENTRIES A, TBL_LOANPAYMENTHISTORY B, TBL_LOANS C " +
            "where A.id = B.LoanEntryID AND A.LoanCode = C.id AND A.EmpID = '" + empno + "' ";
        qry += (expr == "" ? "" : expr);
        qry += " order by DateTrans Desc";
        dt = new DataTable();
        dt.Columns.AddRange(new DataColumn[6] { new DataColumn("id"), new DataColumn("Name"), new DataColumn("amountPaid"),
            new DataColumn("beforepaymentbal"), new DataColumn("afterpaymentbal"), new DataColumn("DateTrans")});
        conn = new SqlConnection(connectionstring);
    ...
    public string GetEmployeePayrollGroup(string empno)
    {
        string rec = "";
        SqlConnection conn_fn = new SqlConnection(connectionstring);
        conn_fn.Open();
        SqlDataReader dread_fn;
        SqlCommand cmd1 = new SqlCommand("SELECT emp_PayrollGroup from TBL_EMPLOYEE_MASTER where emp_EmpID = '" + empno + "'", conn_fn);
        dread_fn = cmd1.ExecuteReader();
        dread_fn.Read();
        if (dread_fn.HasRows)
        {
    ...
    public ListItem[] GetDropDownMenuListCutOffWherePayrollGroup(string payrollGroup)
    {
        Dictionary<string, string> ddlist = new Dictionary<string, string>();
        string qry = "Select id,CDesc from TBL_CUTOFF ";
        if (payrollGroup != "")
        {
            qry += " where PayrollGroup = " + payrollGroup + "";
        }
        //qry += " order by CODate Desc";
        qry += " order by MONTH(cofrom) asc";
        conn = new SqlConnection(connectionstring);
        conn.Open();
