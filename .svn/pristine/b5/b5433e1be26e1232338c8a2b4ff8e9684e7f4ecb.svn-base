            ...
            <div class="container-fluid">
                ...
                <section class="card">
                    <div class="card-header">
                        ...
                        <a href="LatesReport.aspx" class="btn btn-default"><i class="fa fa-list"></i><span class="h6">List</span></a>
                            ...
                            <div class="container-fluid">
                                <div class="box-body">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="monthlydt" ValidationGroup="CreateCutOffGroup" ForeColor="Red" ErrorMessage="Field Required"></asp:RequiredFieldValidator></span></label>
                                            ...
                                            <br />
                                                    <div class="footer">
                                                        <asp:Button ID="btnSearch" runat="server" class="btn btn-info" Text="Export Excel"
                                                            OnClick="btnExport_Click"></asp:Button>
                                                        <asp:Button ID="btnExportPFG" runat="server" class="btn btn-info" Text="Export PDF"
                                                            OnClick="ExportToPDF"></asp:Button>
                                                    </div>
                                            <br />
