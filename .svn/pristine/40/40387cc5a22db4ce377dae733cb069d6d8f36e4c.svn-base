...
{
    public partial class OTSummary : System.Web.UI.Page
    {
        ...
        {
            string dates = "B.OTDate BETWEEN '" + txt_txtStartDate.Value + "' AND '" + txt_txtEndDate.Value + "'";
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            {
                string expr = dates + " AND " + comp;
                dg.DataSource = tk.populateGridOTSummaryCol(expr);
                dg.DataBind();
            }
            if (ddlDept.SelectedIndex != 0)
            {
            ...
            if (dg.Items.Count > 0)
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename= OTSummary" + txt_txtStartDate.Value + "-" + txt_txtEndDate.Value + ".xls");
                ...
                swriter.Write("<table style='border-style:solid; border-width:thin;font-weight:bold;font-size:18px'><tr><td colspan='3' style='border-style:solid; border-width:thin;text-align:center'>Overtime Summary for " + cm.FormatDateddMMMMyyyy(txt_txtStartDate.Value) + " to " + cm.FormatDateddMMMMyyyy(txt_txtEndDate.Value) + "</td></tr>" +
             "</table>");
                //DataGrid dg = new DataGrid();
                ...
                Response.End();
                cm.AddLog("User " + Session["USER_DISPLAY_NAME"].ToString().ToUpper() + " exported OT Summary",
        ...
        protected void btnEXportPDF_Click(object sender, EventArgs e)
        {
            ...
            {
                string expr = dates + " AND " + comp;
                dt = tk.populateGridOTSummaryCol(expr);
            }
            if (ddlDept.SelectedIndex != 0)
            {
                string expr = dates + " AND " + dept;
            ...
            if (GridView2.Rows.Count > 0)
            {
                ...
                pdfDoc.Add(new Phrase("\r\nOvertime Summary for " + cm.FormatDateddMMMMyyyy(txt_txtStartDate.Value) + " to " + cm.FormatDateddMMMMyyyy(txt_txtEndDate.Value) + "\n"));
