...
namespace HRIS_APPELECTRIC.Pages
{
    public partial class CompanyList : System.Web.UI.Page
    {
        ...
        protected void txtItem_TextChanged(object sender, EventArgs e)
        {
            ...
            string txtSearchCName = ((TextBox)currentRow.FindControl("txtSearchCName")).Text;

            string expr = emp.build_or_like_param(true, saveSearchParam(txtSearchCName));
            ...
            GridViewList.DataSource = emp.populateGridCompanyCol(expr);
            GridViewList.DataBind();



        }
        Dictionary<string, string> saveSearchParam(string txtSearchCName)
        {
            Dictionary<string, string> param = new Dictionary<string, string>();
            param.Add("CoName", "'%" + txtSearchCName + "%'");
        ...
        protected void GridViewList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                getconame = cm.GetSpecificDataFromDB("CoName", "TBL_COMPANY", "where id = " + e.CommandArgument.ToString() + "");
                emp.DeleteQuery("TBL_COMPANY", "where id =" + e.CommandArgument.ToString() + "");
                cm.AddLog("User " + Session["USER_DISPLAY_NAME"].ToString().ToUpper() + " removed COMPANY " + getconame,
        ...
        {
            upd_CompanyName.Value = cm.GetSpecificDataFromDB("CoName", "TBL_COMPANY", "where id = " + id + "");
        }
        ...
        {
            vw_ID.Value = cm.GetSpecificDataFromDB("id", "TBL_COMPANY", "where id = " + id + "");
            vw_CompanyName.Value = upd_CompanyName.Value;
        }

        Dictionary<string, string> saveUpdateParam()
        {
            Dictionary<string, string> param = new Dictionary<string, string>();
            param.Add("CoName", "'" + upd_CompanyName.Value + "'");
        ...
        protected void btnsaveUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (confirmValue == "Yes")
            {
                getconame = cm.GetSpecificDataFromDB("CoName", "TBL_COMPANY", "where id = " + HiddenEmpID.Value + "");
                if (cm.UpdateQueryCommon(saveUpdateParam(), "TBL_COMPANY", "id = " + HiddenEmpID.Value + ""))
                {
                    if (getconame != upd_CompanyName.Value)
                    {
                        cm.AddLog("User " + Session["USER_DISPLAY_NAME"].ToString().ToUpper() + " changed COMPANY NAME for " + getconame + " from " + getconame + " to " + upd_CompanyName.Value,
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            dg.DataSource = emp.populateGridCompany();
            dg.DataBind();
            if (dg.Items.Count > 0)
            {
                Response.Clear();
                ...
                cm.AddLog("User " + Session["USER_DISPLAY_NAME"].ToString().ToUpper() + " exported Company List to Excel File",
        ...
        protected void ExportToPDF(object sender, EventArgs e)
        {
            ...
            if (GridView2.Rows.Count > 0)
            {
                ...
                Response.AddHeader("content-disposition",
                    ...
                    "attachment;filename=CompanyList.pdf");
