                                                    ...
                                                    <div style="overflow-x: auto;" id="display-grid" class="grid-view box-body">
                                                        ...
                                                        <asp:GridView ID="GridViewList" runat="server" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <HeaderTemplate>
                                                                        <asp:LinkButton ID="linkbtn_0" CssClass="h8" Text='Payroll Group' runat="server" CommandName="Sort" CommandArgument="payrollgrpname"></asp:LinkButton><br />
                                                                ...
                                                                <asp:TemplateField>
                                                                    <HeaderTemplate>
                                                                        ...
                                                                        <asp:TextBox ID="txtSearchCODate" runat="server" OnTextChanged="txtItem_TextChanged" TextMode="Date" Width="100%" AutoPostBack="true"></asp:TextBox>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <HeaderTemplate>
                                                                        ...
                                                                        <asp:TextBox ID="txtSearchCOFrom" runat="server" OnTextChanged="txtItem_TextChanged" TextMode="Date" Width="100%" AutoPostBack="true"></asp:TextBox>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <HeaderTemplate>
                                                                        ...
                                                                        <asp:TextBox ID="txtSearchCOTo" runat="server" OnTextChanged="txtItem_TextChanged" TextMode="Date" Width="100%" AutoPostBack="true"></asp:TextBox>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <HeaderTemplate>
                                                                        ...
                                                                        <asp:TextBox ID="txtSearchCDesc" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true"></asp:TextBox>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-footer">
                            <asp:Button ID="btnsaveUpdate" runat="server" Text="Update" CssClass="btn btn-primary"
                                OnClick="btnsaveUpdate_Click" OnClientClick="Confirm()" UseSubmitBehavior="false" ValidationGroup="UpdateCutOffGroup"></asp:Button>
                        ...
                        <div class="modal-body" style="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <label for="vw_creditMonth" class="required">Month</label>
                                    <input class="form-control" id="vw_creditMonth" name="vw_creditMonth" type="text" runat="server" disabled="disabled" />

                                    <label for="vw_creditYear" class="required">Year</label>
                                    <input class="form-control" id="vw_creditYear" name="vw_creditYear" type="text" runat="server" disabled="disabled" />
