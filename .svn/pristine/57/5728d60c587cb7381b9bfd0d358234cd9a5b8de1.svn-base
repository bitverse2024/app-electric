<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="payrollsum.aspx.cs" Inherits="HRIS_APPELECTRIC.Pages.Admin.PayrollPages.payrollsum" %>
                    ...
                    <div class="col-md-12">
                        <div class="content">
                            <div class="container-fluid">
                                ...
                                <h3 class="m-0 text-dark">Payroll<small> Payroll Summary</small></h3>
                                <section class="card">
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="row">
                                                                <div class="form col-lg-4">
                                                                    <label for="lblCreditDate" class="required">Credit Date <span class="required text-red">**</span>
