                                                ...
                                                <div style="overflow-x: auto;" id="display-grid" class="grid-view box-body">
                                                    ...
                                                    <asp:GridView ID="GridViewList" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="LinkButton1" CssClass="" Text='Status' runat="server" CommandName="Sort" CommandArgument="LeaveStatus" Style="color: #0026ff; font-size: 12px; font-weight: bold;"></asp:LinkButton><br />
                                                                      <asp:DropDownList ID="ddlStat" runat="server" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged" AutoPostBack="true" Style=" font-size: 12px;">
                                                                ...
                                                                <ItemTemplate>
                                                                    <span class="" Style=" font-size: 12px;"><%# Eval("LeaveStatus")%></span>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="LinkButton2" Width="200px" CssClass="" Text='Leave Type' runat="server" CommandName="Sort" CommandArgument="LeaveTypeDesc" Style="color: #0026ff; font-size: 12px; font-weight: bold;"></asp:LinkButton><br />
                                                                    <asp:TextBox ID="txtSearchLeaveType" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true" Style=" font-size: 12px;"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <span class="" Style=" font-size: 12px;"><%# Eval("LeaveTypeDesc")%></span>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="LinkButton3" CssClass="" Text='Date From' runat="server" CommandName="Sort" CommandArgument="DateFrom" Style="color: #0026ff; font-size: 12px; font-weight: bold;"></asp:LinkButton><br />
                                                                    <asp:TextBox ID="txtSearchDateFrom" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true" Style=" font-size: 12px;"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <span class="" Style=" font-size: 12px;"><%# Eval("DateFrom")%></span>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="LinkButton4" Width="100px" CssClass="" Text='Date To' runat="server" CommandName="Sort" CommandArgument="DateTo" Style="color: #0026ff; font-size: 12px; font-weight: bold;"></asp:LinkButton><br />
                                                                    <asp:TextBox ID="txtSearchDateTo" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true" Style=" font-size: 12px;"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <span class="" Style=" font-size: 12px;"><%# Eval("DateTo")%></span>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="LinkButton5" CssClass="" Text='Hours' runat="server" CommandName="Sort" CommandArgument="LeaveHours" Style="color: #0026ff; font-size: 12px; font-weight: bold;"></asp:LinkButton><br />
                                                                    <asp:TextBox ID="txtSearchLeaveHours" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true" Style=" font-size: 12px;"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <span class="" Style=" font-size: 12px;"><%# Eval("LeaveHours")%></span>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="LinkButton6" CssClass="" Width="100px" Text='Date Filed' runat="server" CommandName="Sort" CommandArgument="DateFiled" Style="color: #0026ff; font-size: 12px; font-weight: bold;"></asp:LinkButton><br />
                                                                    <asp:TextBox ID="txtSearchDateFiled" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true" Style=" font-size: 12px;"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <span class="" Style=" font-size: 12px;"><%# Eval("DateFiled")%></span>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="LinkButton7" CssClass="" Width="200px" Text='Approver 1' runat="server" CommandName="Sort" CommandArgument="Approver1" Style="color: #0026ff; font-size: 12px; font-weight: bold;"></asp:LinkButton><br />
                                                                    <asp:TextBox ID="txtSearchApprover1" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true" Style=" font-size: 12px;"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <span class="" Style=" font-size: 12px;"><%# Eval("Approver1")%></span>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="LinkButton8" CssClass="" Width="200px" Text='Date Approved 1' runat="server" CommandName="Sort" CommandArgument="DateApproved1" Style="color: #0026ff; font-size: 12px; font-weight: bold;"></asp:LinkButton><br />
                                                                    <asp:TextBox ID="txtSearchDapproved1" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true" Style=" font-size: 12px;"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <span class="" Style=" font-size: 12px;"><%# Eval("DateApproved1")%></span>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="LinkButton9" CssClass="" Width="200px" Text='Approver 2' runat="server" CommandName="Sort" CommandArgument="Approver2" Style="color: #0026ff; font-size: 12px; font-weight: bold;"></asp:LinkButton><br />
                                                                    <asp:TextBox ID="txtSearchApprover2" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true" Style=" font-size: 12px;"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <span class="" Style=" font-size: 12px;"><%# Eval("Approver2") %></span>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="LinkButton10" CssClass="" Width="200px" Text='Date Approved 2' runat="server" CommandName="Sort" CommandArgument="DateApproved2" Style="color: #0026ff; font-size: 12px; font-weight: bold;"></asp:LinkButton><br />
                                                                    <asp:TextBox ID="txtSearchDApproved2" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true" Style=" font-size: 12px;"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <span class="" Style=" font-size: 12px;"><%# Eval("DateApproved2")%></span>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="LinkButton11" CssClass="" Width="200px" Text='Remarks' runat="server" CommandName="Sort" CommandArgument="Reason" Style="color: #0026ff; font-size: 12px; font-weight: bold;"></asp:LinkButton><br />
                                                                    <asp:TextBox ID="txtSearchReason" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true" Style=" font-size: 12px;"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <span class="" Style=" font-size: 12px;"><%# Eval("Reason")%></span>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="LinkButton12" CssClass="" Width="200px" Text='Reason for Disapproval' runat="server" CommandName="Sort" CommandArgument="reasons2" Style="color: #0026ff; font-size: 12px; font-weight: bold;"></asp:LinkButton><br />
                                                                    <asp:TextBox ID="txtSearchDisapproval" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true" Style=" font-size: 12px;"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <span class="" Style=" font-size: 12px;"><%# Eval("reasons2")%></span>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="leave_hours" class="required">
                                                                Leave Hours <span class="required text-red">*</span><asp:RequiredFieldValidator
                                                                    ID="RequiredFieldValidator13" runat="server" ErrorMessage="Field Required" ControlToValidate="leave_hours" ForeColor="Red" ValidationGroup="leaves"></asp:RequiredFieldValidator></label>
			...
			<input style="height:20px;" class="form-control" id="CODate" name="Leavesapp[CODate]" type="text" />			</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="upd_leave_hours" class="required">
                                            Leave Hours <span class="required text-red">*</span><asp:RequiredFieldValidator
                                                ID="RequiredFieldValidator50" runat="server" ErrorMessage="Field Required" ControlToValidate="upd_leave_hours" ForeColor="Red" ValidationGroup="updapproval"></asp:RequiredFieldValidator></label>
