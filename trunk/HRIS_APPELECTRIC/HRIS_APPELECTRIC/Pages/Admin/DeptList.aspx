                                        ...
                                        <div class='printableArea'>
                                            ...
                                            <div class="form">
                                                ...
                                                <div class="row showgrid">
                                                    <div class="col-lg-6">
                                                        <label for="Department_DeptName" class="required">Department Name <span class="required text-red">*</span></label><input class="form-control" maxlength="40" name="Department[DeptName]" id="Department_DeptName" type="text" runat="server" />
                                                    </div>
                                                    <div class="col-lg-6">
                                                    </div>
                                                </div>
