...
{
    public partial class EmployeeListForAdjustment : System.Web.UI.Page
    {
        ...
        protected void GridViewList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "view")
            {
                ...
                Response.Redirect("~/Pages/Admin/PayrollPages/EmployeeAdjustmentList.aspx?empid=" + e.CommandArgument.ToString());
