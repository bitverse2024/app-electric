...
namespace HRIS_APPELECTRIC.Pages.Admin.PayrollPages
{
    public partial class CreateEmployeeAdjustment : System.Web.UI.Page
    {
        ...
        void clearfield()
        {
            ...
            AdjustmentAdd.Text = "0";
            AdjRemarks.Value = "";
            AdjustmentOthersAdd.Text = "0";
        ...
        Dictionary<string, string> saveParam()
        {
            ...
            param.Add("AdjustmentAdd", "" + AdjustmentAdd.Text + "");
            param.Add("AdjRemarks", "'" + AdjRemarks.Value + "'");
            param.Add("AdjustmentOthersAdd", "" + AdjustmentOthersAdd.Text + "");
