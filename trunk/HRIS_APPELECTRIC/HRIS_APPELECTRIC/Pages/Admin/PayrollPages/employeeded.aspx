     ...
     <div class="col-md-12">
        <div class="content">
            <div class="container-fluid">
                ...
                <h3 class="m-0 text-dark">Payroll<small>Government Deductions</small></h3>
                <section class="card">
                            ...
                            <div class="container-fluid">
                                <div id="display-grid" class="grid-view">
                                    ...
                                    <asp:GridView ID="GridViewList" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <EmptyDataTemplate>
                                            <center><h1>NO DEDUCTION AVAILABLE</h1></center>
                                        </EmptyDataTemplate>
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    <asp:LinkButton ID="lnkempTax" CssClass="h8" Text='Tax' runat="server" CommandName="Sort" CommandArgument="empTax"></asp:LinkButton><br />
                                                    <asp:TextBox ID="txtempTax" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%"></asp:TextBox>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblempTax" CssClass="h6" Text='<%# Eval("empTax") %>' runat="server"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                ...
                <asp:UpdatePanel ID="upListDetails" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <label class="control-label required" for="updSSS">SSS <span class="required text-red"></span></label>
                                    <div class="controls">
                                       <%-- <input class="form-control" maxlength="50" id="updSSS" type="text" runat="server" />--%>
                                        <asp:TextBox TextMode="Number" ID="updSSS" class="form-control" runat="server"  step="0.01"/>
                                    </div>
                                     <label class="control-label required" for="updPhilhealth">Philhealth <span class="required text-red"></span></label>
                                    <div class="controls">
                                       <%-- <input class="form-control" maxlength="50" id="updPhilhealth" type="text" runat="server" />--%>
                                        <asp:TextBox TextMode="Number" ID="updPhilhealth" class="form-control" runat="server"  step="0.01"/>
                                    </div>
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:TextBox TextMode="Number" ID="updPagibig" class="form-control" runat="server"  step="0.01"/>
                                    </div>
                                    <label class="control-label required" for="updTax">Tax</label>
                                    <div class="controls">
                                        <%--<input class="form-control" maxlength="50" id="updTax" type="text" runat="server" />--%>
                                        <asp:TextBox TextMode="Number" ID="updTax" class="form-control" runat="server"  step="0.01"/>
                                    </div>
