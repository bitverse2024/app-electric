...
{
    public partial class addded : System.Web.UI.Page
    {
        ...
        protected void GridViewList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "view")
            {
                ...
                Response.Redirect("~/Pages/Admin/PayrollPages/employeeded.aspx?empid=" + e.CommandArgument.ToString());
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename= Deductions" + ".xls");
            ...
            cm.AddLog("User " + Session["USER_DISPLAY_NAME"].ToString().ToUpper() + " exported Deductions",
