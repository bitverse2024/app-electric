                                    ...
                                    <div class="box-body">
                                        <div class="form">                                            
                                                ...
                                                <div class="showgrid row">
                                                    <div class="col-lg-6">
                                                        <label for="Offense_Key" class="required">
                                                            Offense Key <span class="required text-red">*
               
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Offense_Key" ValidationGroup="CreateOffenseGroup" ForeColor="Red" ErrorMessage="Field Required"> </asp:RequiredFieldValidator>
                                                            </span>
                                                        </label>
                                                        <input class="form-control" maxlength="500" name="Offense_Key[Offense_Key]" id="Offense_Key" type="text" runat="server" />
                                                        ...
                                                        <label for="Offense_Desc" class="required">
                                                            Offense Description <span class="required text-red">*
               
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Offense_DescDetailed" ValidationGroup="CreateOffenseGroup" ForeColor="Red" ErrorMessage="Field Required"> </asp:RequiredFieldValidator>
                                                            </span>
                                                        </label>
                                                        <textarea class="form-control" maxlength="500" name="Offense_Desc[Offense_DescDetailed]" id="Offense_DescDetailed" runat="server"></textarea>
                                                        <%--<input class="form-control" maxlength="500" name="Offense_Desc[Offense_DescDetailed]" id="Offense_DescDetailed" type="text" runat="server" />--%>
                                                    </div>
                                                </div>
                                                <br />
