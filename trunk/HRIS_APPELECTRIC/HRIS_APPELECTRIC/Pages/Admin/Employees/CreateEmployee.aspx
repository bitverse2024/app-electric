                            ...
                            <div class="container-fluid">
                                ...
                                <div class="showgrid">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Employee_FirstName" ValidationGroup="CreateEmployeeGroup" ForeColor="Red" ErrorMessage="Field Required"></asp:RequiredFieldValidator></span></label><input class="form-control" maxlength="255" name="emp_FirstName" id="Employee_FirstName" type="text" runat="server" />
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator45" runat="server" ControlToValidate="Employee_EmpID" ValidationGroup="CreateEmployeeGroup" ForeColor="Red" ErrorMessage="Field Required">
    </asp:RequiredFieldValidator>
                                                </span>
                                            </label>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="emp_Location" ValidationGroup="CreateEmployeeGroup" ForeColor="Red" ErrorMessage="Field Required"></asp:RequiredFieldValidator></span></label>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator32" runat="server" ControlToValidate="txtBasicPay" ValidationGroup="CreateEmployeeGroup" ForeColor="Red" ErrorMessage="Field Required"></asp:RequiredFieldValidator></span></label>
                                            ...
                                            <%--<label for="txtTotal" class="required">
                                                Total Salary <span class="required text-red">*</span><asp:RequiredFieldValidator
                                                    ID="RequiredFieldValidator13" runat="server" ErrorMessage="Field Required" ForeColor="Red"
                                                    ControlToValidate="txtTotal" ValidationGroup="CreateEmployeeGroup"></asp:RequiredFieldValidator></label>
                                             <div class="input-group">
                                                <input class="form-control" id="txtTotal" name="Leavesapp[LeaveHrs]" type="number" min="1" max="100000" onkeypress="return isNumberKey(event)" runat="server" />
                                            </div>--%>
                                            ...
                                            <label for="emp_WorkDays" class="required">Work Days(per month)<span class="required text-red">*</span><asp:RequiredFieldValidator
                                                                    ...
                                                                    ControlToValidate="emp_WorkDays" ValidationGroup="CreateEmployeeGroup"></asp:RequiredFieldValidator></label>
                                                                <div class="input-group">
	...
	<label for="Employee_ReportingTo2" class="required">2nd Approver</label>	<input class="form-control" id="Employee_ReportingTo2" name="emp_Approver2" type="text" runat="server" />	<input class="form-control" id="hidden-approver2" name="Employee[ReportingTo2]" type="hidden" />	</div>--%>
                                        <label for="emp_RegularizationDate" class="required">
                                            ...
                                            <label for="LeaveCreditPerYear" class="required">
                                                                Leave Credit Per Year<span class="required text-red">*</span><asp:RequiredFieldValidator
                                                                    ID="RequiredFieldValidator15" runat="server" ErrorMessage="Field Required" ControlToValidate="LeaveCreditPerYear" ForeColor="Red" ValidationGroup="CreateEmployeeGroup"></asp:RequiredFieldValidator></label>
                                                            <asp:TextBox TextMode="Number" ID="LeaveCreditPerYear" class="form-control" runat="server" min="0" max="365" value="0" step="1"/>
                                    ...
                                    <div class="form-actions">
                                        <asp:Button ID="btnCreate" class="btn btn-primary" Width="80px" runat="server" Text="Save"
                                                    OnClick="btnSubmit_Click"  ValidationGroup="CreateEmployeeGroup"></asp:Button>
