                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            ...
                                                            <asp:TextBox ID="txtSearchProvinceName" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true"></asp:TextBox>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            ...
                                                            <asp:TextBox ID="txtSearchProvinceInclude" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true"></asp:TextBox>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
