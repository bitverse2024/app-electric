...
namespace HRIS_APPELECTRIC.Pages.Admin.Reports
{
    public partial class OBTSummary : System.Web.UI.Page
    {
        ...
        {
            string dates = "B.DateFrom BETWEEN '" + txt_txtBussDate.Value + "' AND '" + txt_txtEndDate.Value + "'";
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (dg.Items.Count > 0)
            {
                ...
                swriter.Write("<table style='border-style:solid; border-width:thin;font-weight:bold;font-size:18px'><tr><td colspan='3' style='border-style:solid; border-width:thin;text-align:center'>OBT Summary for " + cm.FormatDateddMMMMyyyy(txt_txtBussDate.Value) + " to " + cm.FormatDateddMMMMyyyy(txt_txtEndDate.Value) + "</td></tr>" +
             "</table>");
                //DataGrid dg = new DataGrid();
        ...
        protected void btnExportPDF_Click(object sender, EventArgs e)
        {
            ...
            {
                string expr = dates + " AND " + comp;
                dt = tk.populateGridOBTSummaryCol(expr);
            }
            if (ddlDept.SelectedIndex != 0)
            {
                string expr = dates + " AND " + dept;
            ...
            if (GridView2.Rows.Count > 0)
            {
                ...
                pdfDoc.Add(new Phrase("\r\nOBT Summary for " + cm.FormatDateddMMMMyyyy(txt_txtBussDate.Value) + " to " + cm.FormatDateddMMMMyyyy(txt_txtEndDate.Value) + "\n"));
