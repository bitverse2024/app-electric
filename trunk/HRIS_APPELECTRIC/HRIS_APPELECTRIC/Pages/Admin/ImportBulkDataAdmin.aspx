<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ImportBulkDataAdmin.aspx.cs" Inherits="HRIS_APPELECTRIC.Pages.Admin.ImportBulkDataAdmin" %>
        ...
        <div class="col-md-12">
            <div class="content">
                <div class="container-fluid">
                    ...
                    <h3 class="m-0 text-dark">Admin<small> Import Bulk Data</small></h3>
                    <section class="card">
                        <div class="card-header">
                            <a href="AdminPage.aspx" class="btn btn-default"><i class="fa fa-arrow-left"></i><span class="h6">Back</span></a>
                            <a href="UpdateBulkData.aspx" class="btn btn-default"><i class="fa fa-arrow-circle-o-left"></i><span class="h6">Back</span></a>
                            <a href="ImportBulkDataAdmin.aspx" class="btn btn-default"><i class="fa fa-arrow-circle-o-down"></i><span class="h6">Import Data</span></a>
                        </div>
                        <%--<br />--%>
                        <div class="card-body">
                            <div class="content">
                                <div class="container-fluid">
                                    <div class="box-body">
                                        <div class="form">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <span class="input-group-lg" style="padding-top: 10px">Select File: </span>
