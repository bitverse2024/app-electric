...
namespace HRIS_APPELECTRIC.Pages.Admin
{
    public partial class DivisionList : System.Web.UI.Page
    {
        ...
        protected void txtItem_TextChanged(object sender, EventArgs e)
        {
            ...
            string txtSearchDivName = ((TextBox)currentRow.FindControl("txtSearchDivName")).Text;

            string expr = emp.build_or_like_param(true, saveSearchParam(txtSearchDivName));
            ...
            GridViewList.DataSource = admin.populateGridDivisionCol(expr);
            GridViewList.DataBind();



        }
        Dictionary<string, string> saveSearchParam(string txtSearchDivName)
        {
            Dictionary<string, string> param = new Dictionary<string, string>();
            param.Add("DivName", "'%" + txtSearchDivName + "%'");
        ...
        protected void GridViewList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("~/Pages/Admin/DeptList.aspx?id=" + e.CommandArgument.ToString());
            ...
            {
                getdiv = cm.GetSpecificDataFromDB("DivName", "TBL_DIVISION", "where id = " + e.CommandArgument.ToString() + "");
                emp.DeleteQuery("TBL_DIVISION", "where id =" + e.CommandArgument.ToString() + "");
                cm.AddLog("User " + Session["USER_DISPLAY_NAME"].ToString().ToUpper() + " removed DIVISION " + getdiv,
        ...
        {
            upd_DivisionName.Value = cm.GetSpecificDataFromDB("DivName", "TBL_DIVISION", "where id = " + id + "");
        }
        ...
        {
            vw_ID.Value = cm.GetSpecificDataFromDB("id", "TBL_DIVISION", "where id = " + id + "");
            vw_DivisionName.Value = upd_DivisionName.Value;
        }

        Dictionary<string, string> saveUpdateParam()
        {
            Dictionary<string, string> param = new Dictionary<string, string>();
            param.Add("DivName", "'" + upd_DivisionName.Value + "'");
        ...
        protected void btnsaveUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (confirmValue == "Yes")
            {
                getdiv = cm.GetSpecificDataFromDB("DivName", "TBL_DIVISION", "where id = " + HiddenEmpID.Value + "");
                if (cm.UpdateQueryCommon(saveUpdateParam(), "TBL_DIVISION", "id = " + HiddenEmpID.Value + ""))
                {
                    if (getdiv != upd_DivisionName.Value)
                    {
                        cm.AddLog("User " + Session["USER_DISPLAY_NAME"].ToString().ToUpper() + " changed DIVISION NAME for " + getdiv + " from " + getdiv + " to " + upd_DivisionName.Value,
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            dg.DataSource = admin.populateGridDivision();
            dg.DataBind();
            if (dg.Items.Count > 0)
            {
                Response.Clear();
                ...
                Response.AddHeader("content-disposition", "attachment;filename= DivisionList" + ".xls");
                ...
                cm.AddLog("User " + Session["USER_DISPLAY_NAME"].ToString().ToUpper() + " exported Division List to Excel File",
        ...
        protected void ExportToPDF(object sender, EventArgs e)
        {
            ...
            if (GridView2.Rows.Count > 0)
            {
                ...
                Response.AddHeader("content-disposition",
                    ...
                    "attachment;filename=DivisionList.pdf");
                ...
                cm.AddLog("User " + Session["USER_DISPLAY_NAME"].ToString().ToUpper() + " exported Division List to PDF File",
                    "EXPORT", "x123", "qwg-23", "EXPORT", Session["EMP_ID"].ToString());
