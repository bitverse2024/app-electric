                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <label for="txtCashAd" class="required">
                                                    Cash Advance <span class="required text-red">*</span></label>
                                                <input class="form-control" id="txtCashAd" name="txtCashAd" type="number" min="0" max="100000" onkeypress="return isNumberKey(event)" runat="server" />
                                            <label for="txtLoanBal" class="required">
                                                    Loan Balance <span class="required text-red">*</span></label>
                                                <input class="form-control" id="txtLoanBal" name="txtLoanBal" type="number" min="0" max="100000" onkeypress="return isNumberKey(event)" runat="server" />
