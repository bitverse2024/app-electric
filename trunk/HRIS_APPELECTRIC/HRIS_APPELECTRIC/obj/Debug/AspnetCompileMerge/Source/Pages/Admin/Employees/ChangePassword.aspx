                                            ...
                                            <div class="showgrid row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <label for="passwrd" class="required">
                                                        Enter Password <span class="required text-red">**<asp:RequiredFieldValidator ID="validatorUploader" runat="server" ControlToValidate="passwrd" ValidationGroup="UpdPasswordGroup" ForeColor="Red" ErrorMessage="Field Required">
                                                    ...
                                                    <label for="newpasswrd" class="required">
                                                        New Password <span class="required text-red">**<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="newpasswrd" ValidationGroup="UpdPasswordGroup" ForeColor="Red" ErrorMessage="Field Required">
