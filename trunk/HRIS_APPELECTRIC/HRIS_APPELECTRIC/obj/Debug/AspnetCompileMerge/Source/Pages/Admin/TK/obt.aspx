<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="obt.aspx.cs" Inherits="HRIS_APPELECTRIC.Pages.Admin.TK.obt" %>
    ...
    <div class="col-md-12">
        <div class="content">
            <div class="container-fluid">
                ...
                <h3 class="m-0 text-dark">DTR<small> OBT</small></h3>
                <section class="card">
                    <div class="card-header">
                        <a href="obt.aspx" class="btn btn-default"><i class="fa fa-list"></i><span class="h6">List Employees</span></a>
                    </div>
                    <div class="card-body">
                        <div class="content">
                            <div class="container-fluid">
                                <div class="box-body">
                                    <div class="box-header">
                                        <h4 class="box-title">OBT List</h4>
                                    </div>
                                        ...
                                        <asp:GridView ID="GridViewList" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="10%">
                                                    <HeaderTemplate>
                                                        <asp:Label ID="lblReset" CssClass="h8" Text='Add OBT' runat="server" CommandName="Reset" CommandArgument="Reset"></asp:Label><br />
