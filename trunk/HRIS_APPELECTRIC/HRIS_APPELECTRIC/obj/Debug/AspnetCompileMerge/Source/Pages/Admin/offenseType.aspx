            ...
            <div class="content">
                ...
                Advanced Search
                                        ...
                                        <div class="search-form" style="display: none">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <label for="Offenses_id" class="required">Off Code <span class="required text-red">**</span></label><input class="form-control" maxlength="3" name="Offenses[id]" id="Offenses_id" type="text">
                                                </div>
                                                <div class="col-lg-6">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            ...
                                                            <asp:TextBox ID="txtSearchoffense_desc" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true"></asp:TextBox>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Width="15%">
                                                        <ItemTemplate>
                                                            <center>
			                                            <asp:LinkButton ID="btnView" runat="server" ForeColor="Black" Font-Size="Large" CommandName="view" CommandArgument='<%# Eval("offenseKey") %>'><i class="fa fa-eye"></i></asp:LinkButton> &nbsp;
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <label for="upd_offense_key" class="required">
                                        Offense Key<span class="required">*</span><asp:RequiredFieldValidator
                                            ID="RequiredFieldValidator2" runat="server" ErrorMessage="Field Required" ControlToValidate="upd_offense_key"
                                            ForeColor="Red" ValidationGroup="updOff"></asp:RequiredFieldValidator></label>
                                    <div class="input-group date">
                                        <input class="form-control" id="upd_offense_key" name="txtoffense_key" type="text" runat="server" />
                                    </div>
                                    <label for="upd_offense_desc" class="required">
                                        Offense <span class="required text-red">**</span><asp:RequiredFieldValidator
                                    ...
                                    <label for="upd_offense_desc" class="required">
                                        Offense Description<span class="required">*</span><asp:RequiredFieldValidator
                                            ID="RequiredFieldValidator3" runat="server" ErrorMessage="Field Required" ControlToValidate="upd_offense_descdetailed"
                                            ForeColor="Red" ValidationGroup="updOff"></asp:RequiredFieldValidator></label>
                                    <div class="input-group date">
                                        <textarea class="form-control" maxlength="500" name="txtoffense_descdetailed" id="upd_offense_descdetailed" runat="server"></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <table>
                                        <tr>
                                            <td>
                                                <label for="vw_ID" class="required">Offense Key: </label>
                                                <asp:Label ID="vw_ID" runat="server" Text="Label"></asp:Label>
                                        ...
                                        <tr>
                                            <td>
                                                <label for="vw_offense_desc" class="required">Offense: </label>
                                                <asp:Label ID="vw_offense_desc" runat="server" Text="Label"></asp:Label>
                                            </td>
                                        </tr>
