<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="fts.aspx.cs" Inherits="HRIS_APPELECTRIC.Pages.Admin.TK.fts" %>
    ...
    <div class="col-md-12">
        <div class="content">
            <div class="container-fluid">
                ...
                <h3 class="m-0 text-dark">DTR<small> Unaccounted Attendance</small></h3>
                <section class="card">
                    <div class="card-header">
                        <a href="fts.aspx" class="btn btn-default"><i class="fa fa-list"></i><span class="h6">List Employees</span></a>
                    </div>
                    <div class="card-body">
                        <div class="content">
                            <div class="container-fluid">
                                <div class="box-body">
                                    <div class="box-header">
                                        <h4 class="box-title">Unaccounted Attendance List</h4>
                                    </div>
                                        ...
                                        <asp:GridView ID="GridViewList" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblFullName" CssClass="" Text='<%# Eval("FullName") %>' runat="server"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderStyle-Width="10%">
                                                    <HeaderTemplate>
                                                        <%--<asp:LinkButton ID="lblReset" Text='Reset' runat="server" CommandName="Reset" CommandArgument="Reset"></asp:LinkButton><br />--%>
                                                        <asp:Label ID="Label1" CssClass="h8" runat="server" Text="Add Unaccounted Attendance"></asp:Label>
