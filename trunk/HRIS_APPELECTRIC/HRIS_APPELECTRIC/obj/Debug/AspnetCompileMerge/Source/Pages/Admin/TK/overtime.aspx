<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="overtime.aspx.cs" Inherits="HRIS_APPELECTRIC.Pages.Admin.TK.overtime" %>
    ...
    <div class="col-md-12">
        <div class="content">
            <div class="container-fluid">
                ...
                <h3 class="m-0 text-dark">DTR<small> Overtime</small></h3>
                <section class="card">
                    <div class="card-header">
                        <a href="overtime.aspx" class="btn btn-default"><i class="fa fa-list"></i><span class="h6">List Employees</span></a>
                    </div>
                            ...
                            <div class="container-fluid">
                                <div class="box-body">
                                    <div class="box-header">
                                        <h4 class="box-title">Overtime List</h4>
                                    </div>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="10%">
                                                    <HeaderTemplate>
                                                        ...
                                                        <asp:Label ID="Label1" runat="server" CssClass="h8" Text="Add Overtime"></asp:Label>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
