<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="PayrollGroup.aspx.cs" Inherits="HRIS_APPELECTRIC.Pages.Admin.PayrollGroup" %>
                                        ...
                                        <div id="display-grid" class="grid-view">
                                            ...
                                            <asp:GridView ID="GridViewList" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="linkbtn_1" CssClass="h8" Text='Payroll Group Name' runat="server" CommandName="Sort" CommandArgument="payrollgrpname"></asp:LinkButton><br />
                                                            <asp:TextBox ID="txtSearchPayrollGrpName" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true"></asp:TextBox>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <span class="h5"><%# Eval("payrollgrpname")%></span>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="linkbtn_2" CssClass="h8" Text='Payroll Mode' runat="server" CommandName="Sort" CommandArgument="payrollmode"></asp:LinkButton><br />
                                                            <asp:TextBox ID="txtSearchPayrollMode" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true"></asp:TextBox>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <span class="h5"><%# Eval("payrollmode")%></span>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="linkbtn_3" CssClass="h8" Text='Location' runat="server" CommandName="Sort" CommandArgument="grplocation"></asp:LinkButton><br />
                                                            <asp:TextBox ID="txtSearchLocation" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%" AutoPostBack="true"></asp:TextBox>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <span class="h5"><%# Eval("grplocation")%></span>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <label for="upd_Code" class="required">Payroll Group Name</label>
                                    <input size="11" class="form-control" id="upd_Code" name="Empsched[Sched_TimeIn]" type="text" maxlength="50" runat="server" />
                                    <label for="upd_Desc" class="required">Payroll Mode</label>
                                    <input size="11" class="form-control" id="upd_Desc" name="Empsched[Sched_TimeOut]" type="text" maxlength="100" runat="server" />
                                    <label for="upd_Level" class="required">Location</label>
                        ...
                        <div class="modal-body" style="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input size="11" class="form-control" id="vw_ID" name="Empsched[Sched_TimeIn]" type="text" maxlength="50" runat="server" disabled="disabled" />
                                    <label for="vw_Code" class="required">Payroll Group Name</label>
                                    <input size="11" class="form-control" id="vw_Code" name="Empsched[Sched_TimeIn]" type="text" maxlength="100" runat="server" disabled="disabled" />
                                    <label for="vw_Desc" class="required">Payroll Mode</label>
                                    <input size="11" class="form-control" id="vw_Desc" name="Empsched[Sched_TimeOut]" type="text"  runat="server" disabled="disabled" />
                                    <label for="vw_Level" class="required">Location</label>
