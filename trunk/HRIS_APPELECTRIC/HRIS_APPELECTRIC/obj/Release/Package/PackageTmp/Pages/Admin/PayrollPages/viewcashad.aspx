<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="viewcashad.aspx.cs" Inherits="HRIS_APPELECTRIC.Pages.Admin.PayrollPages.viewcashad" %>
            ...
            <div class="container-fluid">
                ...
                <section class="card">
                    <div class="card-header">
                        <a href="viewcashad.aspx" class="btn btn-default"><i class="fa fa-list"></i><span class="h6">List</span></a>
                        <a href="<%= ResolveUrl("~/Pages/Admin/PayrollPages/createCashAd.aspx?empid="+empno+"")%>" class="btn btn-default"><i class="fa fa-plus"></i><span class="h6">Create</span></a>
                    </div>
                    <div class="card-body">
                        <div class="content">
                            <div class="container-fluid">
                                <div id="display-grid" class="grid-view">
                                    ...
                                    <asp:GridView ID="GridViewList" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    <asp:LinkButton ID="lnkCashAd" CssClass="h8" Text='Cash Advance' runat="server" CommandName="Sort" CommandArgument="CashAdvance"></asp:LinkButton><br />
                                                    <asp:TextBox ID="txtCashAd" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%"></asp:TextBox>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCashAd" CssClass="h6" Text='<%# Eval("CashAdvance") %>' runat="server"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    <asp:LinkButton ID="lnkLoanBal" CssClass="h8" Text='Loan Balance' runat="server" CommandName="Sort" CommandArgument="LoanBalance"></asp:LinkButton><br />
                                                    <asp:TextBox ID="txtLoanBal" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%"></asp:TextBox>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLoanBal" CssClass="h6" Text='<%# Eval("LoanBalance") %>' runat="server"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                ...
                <asp:UpdatePanel ID="upListDetails" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <label class="control-label required">Cutoff <span class="required text-red">*</span></label>
                                    <div class="controls">
                                        <asp:DropDownList ID="ddlCutOff" runat="server"></asp:DropDownList>
                                    </div>
                                    <label class="control-label required" for="updCashAd">Cash Advance <span class="required text-red">*</span></label>
                                    <div class="controls">
                                        <input class="form-control" maxlength="50" id="updCashAd" type="text" runat="server" />
                                    </div>
                                    <label class="control-label required" for="updLoanBal">Loan Balance </label>
                                    <div class="controls">
                                        <input class="form-control" maxlength="50" id="updLoanBal" type="text" runat="server" />
                                    </div>
