<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="DivisionList.aspx.cs" Inherits="HRIS_APPELECTRIC.Pages.Admin.DivisionList" %>
        ...
        <div class="col-md-12">
            <div class="content">
                <div class="container-fluid">
                    ...
                    <h3 class="m-0 text-dark">Admin<small> Division</small></h3>
                    <section class="card">
                        <div class="card-header">
                            <a href="AdminPage.aspx" class="btn btn-default"><i class="fa fa-arrow-left"></i><span class="h6">Back</span></a>
                            <a href="CreateDivision.aspx" class="btn btn-default"><i class="fa fa-plus"></i><span class="h6">Create</span></a>
                            <a href="DivisionList.aspx" class="btn btn-default"><i class="fa fa-th-list"></i><span class="h6">List</span></a>
                            <a runat="server" onserverclick="ExportToPDF" class="btn btn-default"><i class="fa fa-arrow-circle-o-up"></i><span class="h6">Export to PDF</span></a>
                ...
                Advanced Search
                                        ...
                                        <div id="display-grid" class="grid-view">
                                            ...
                                            <asp:GridView ID="GridViewList" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <EmptyDataTemplate>
                                                    <center><h1>NO DIVISION AVAILABLE</h1></center>
                                                </EmptyDataTemplate>
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="linkbtn_1"  CssClass="h8" Text='Division Name' runat="server" CommandName="Sort" CommandArgument="DivName"></asp:LinkButton><br />
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Width="30%">
                                                        <ItemTemplate>
                                                            <center>
                                                                <asp:Button ID="btnAdd" CssClass="btn-success btn-xs" runat="server" Text="Add Department" CommandName="add" CommandArgument='<%# Eval("id") %>'  />&ensp;
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <label for="upd_DivisionName" class="required">
                                        Division Name<span class="required">*</span><asp:RequiredFieldValidator
                                            ID="RequiredFieldValidator1" runat="server" ErrorMessage="Field Required" ControlToValidate="upd_DivisionName"
                                            ForeColor="Red" ValidationGroup="updDiv"></asp:RequiredFieldValidator></label>
                                    <div class="input-group date">

                                        <input class="form-control" id="upd_DivisionName" name="txtDivisionName" type="text" runat="server" />
                                    </div>
                        ...
                        <div class="modal-footer">
                            <asp:Button ID="btnsaveUpdate" runat="server" Text="Update"  UseSubmitBehavior="true"
                                OnClick="btnsaveUpdate_Click" CssClass="btn btn-primary"
                                OnClientClick="Confirm()" ValidationGroup="updDiv"></asp:Button>
                        ...
                        <div class="modal-body" style="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <label for="vw_DivisionName" class="required">Division Name</label>
                                    <input class="form-control" id="vw_DivisionName" name="vw_DivisionName" type="text" runat="server" disabled="disabled" />
                                </div>
