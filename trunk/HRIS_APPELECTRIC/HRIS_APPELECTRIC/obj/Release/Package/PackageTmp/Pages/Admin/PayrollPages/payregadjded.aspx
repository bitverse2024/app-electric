<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="payregadjded.aspx.cs" Inherits="HRIS_APPELECTRIC.Pages.Admin.PayrollPages.payregadjded" %>
    ...
    <div class="col-md-12">
        <div class="content">
            <div class="container-fluid">
                ...
                <h3 class="m-0 text-dark">Payroll Adjustment<small> Deductions</small></h3>
                <section class="card">
                    <div class="card-header">
                        <a href="createpayregadjded.aspx" class="btn btn-default"><i class="fa fa-plus"></i><span class="h6">Create</span></a>
                                    ...
                                    <div id="display-grid" class="grid-view box-body">
                                        <asp:GridView ID="GridUserList" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <asp:LinkButton ID="lnkDed" Text='Deduction' runat="server" CommandName="Sort" CommandArgument="Ded"></asp:LinkButton><br />
                                                        <asp:TextBox ID="txtDed" runat="server" OnTextChanged="txtItem_TextChanged" Width="100%"></asp:TextBox>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <label for="upd_EmpName" class="required">Deduction</label>
                                    <select class="form-control" id="upd_DedCode" runat="server">
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-body" style="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <label class="control-label required">Deduction</label>
                                    <input class="form-control" id="vw_Ded" type="text" runat="server" disabled="disabled" />
